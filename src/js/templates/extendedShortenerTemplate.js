				...
				<form class="logged-hero__form form" id="shortener-form" action="#" method="post" autocomplete="off">
					<div class="form__input-wrapper form__input-wrapper--long-link">
						<label class="form__label form__label--long-link" for="long-link">
							<input class="form__input form__input--long-link" id="long-link" type="url" name="longLink" aria-label="Длинная ссылка" placeholder="Ссылка для сокращения" required>
							<span class="error-label"></span>
						</label>
						<button class="form__button round-button shortener-button round-button--submit" id="shortener-submitBtn" aria-label="Создать короткую ссылку" type="submit" name="submit">
					...
					<div class="form__optional-inputs">
						<div class="form__input-wrapper form__input-wrapper--link-name">
							<label class="form__label form__label--link-name" for="link-name">
								<input class="form__input form__input--link-name" id="link-name" type="text" name="linkName" aria-label="Имя ссылки" placeholder="Имя ссылки">
								<span class="error-label"></span>
							</label>
							<button type="button" class="form__button round-button round-button--clear clear-button" aria-label="Очистить поле имени ссылки">
								<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-x"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>
							</button>
						</div>
						<div class="form__input-wrapper form__input-wrapper--link-limit">
							<label class="form__label form__label--link-limit" for="link-limit">
								<input class="form__input form__input--link-limit" id="link-limit" type="tel" name="linkLimit" aria-label="Лимит переходов" placeholder="Лимит переходов">
								<span class="error-label"></span>
							</label>
							<button type="button" class="form__button round-button round-button--clear clear-button" aria-label="Очистить поле лимит переходов">
								<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-x"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>
							</button>
						</div>
						<div class="form__input-wrapper form__input-wrapper--link-password">
							<label class="form__label form__label--link-password" for="link-password">
								<input class="form__input form__input--link-password" id="link-password" type="text" name="linkPassword" aria-label="Пароль ссылки" placeholder="Пароль">
								<span class="error-label"></span>
							</label>					
							<button type="button" class="form__button round-button round-button--clear clear-button" aria-label="Очистить поле пароль ссылки">
								<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-x"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>
							</button>
						</div>
						<div class="form__input-wrapper form__input-wrapper--link-start">
							<label class="form__label form__label--link-start" for="link-start">
								<input class="form__input form__input--link-start" id="link-start" type="text" name="linkStartDate" aria-label="Дата начала действия ссылки" placeholder="Начало действия">
								<span class="error-label"></span>
							</label>
							<div class="tooltip form__date-input-tooltip">
								...
								<p class="tooltip__text">Ссылка начнет действовать с&nbsp;выбранных даты и&nbsp;времи</p>
							</div> 
						</div>
						<div class="form__input-wrapper form__input-wrapper--link-end">
							<label class="form__label form__label--link-end" for="link-end">
								<input class="form__input form__input--link-end" id="link-end" type="text" name="linkEndDate" aria-label="Дата окончания действия ссылки" placeholder="Конец действия">
								<span class="error-label"></span>
							</label>
							<div class="tooltip form__date-input-tooltip">
								<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#3d96e5" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-help-circle"><circle cx="12" cy="12" r="10"></circle><path d="M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3"></path><line x1="12" y1="17" x2="12.01" y2="17"></line></svg>
								<p class="tooltip__text">Ссылка прекратит действие в&nbsp;выбранную дату и&nbsp;время</p>
							</div> 
						</div>
					</div>
					<div class="form__input-wrapper form__input-wrapper--short-link">
						...
						<label class="form__label form__label--short-link" for="short-link">
							<input class="form__input form__input--short-link short-link" id="short-link" type="url" name="shortLink" aria-label="Короткаая ссылка" placeholder="Результат" readonly>
						</label>
						<button type="button" class="form__button round-button round-button--copy copy-button" aria-label="Скопировать короткую ссылку">
					...
					<div class="logged-hero__qr-body qr-body">
						...
						<div class="qr-img-wrapper">
							<img class="qr-body__qr-img qr-img" id="qr" src="./img/qr.png" alt="QR-код" aria-label="QR-код">
						</div>
					</div>
				</form>
			</div>
