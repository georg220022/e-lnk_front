const linkTemplate = (obj, id) => {
    ...
    <div class="link-wrapper" data-link-id="${id}">
        ...
        <ul class="accordion">
          <li class="accordion__item">
            <div class="link__head">
              <button class="accordion__button" type="button" aria-label="Открыть информацию о ссылке">
              ...
              <div class="link__short form__input-wrapper--short-link">
                <label class="form__label form__label--short-link" for="short-link">
                  <input class="form__input--short-link short-link" id="short-link" type="url" name="shortLink"
                         aria-label="Короткая ссылка" value="${obj.shortLink}" placeholder="Результат" readonly>
                </label>
                <button type="button" class="form__button round-button round-button--copy copy-button"
                ...
                <div class="tabs-wrapper">
                  <ul class="tabs">
                    <div class="link__top-body">
                      <input class="link__long-link" aria-label="Длинная ссылка" value="${obj.longLink}" readonly>
                      <div class="link__switching-buttons">
                        <li class="tabs__tab">
                          <button type="button" aria-label="Статистика" class="tabs__button tabs__button--active"
                                  data-tab="#tab_1">
                        ...
                        <li class="tabs__tab">
                          <button type="button" class="tabs__button" aria-label="Настройки" data-tab="#tab_2">
                            <div class="tooltip link__tooltip">
                        ...
                        <div class="link__line-charts">
                          <div class="tabs-wrapper">
                            <ul class="link__line-charts-buttons tabs">
                              <li class="tabs__tab">
                                <button type="button" class="tabs__button tabs__button--active"
                                        aria-label="Стаистика за сутки" data-tab="#hours-chart">
                                  <div class="tooltip link__tooltip">
                              ...
                              <li class="tabs__tab">
                                <button type="button" class="tabs__button" aria-label="Статистика за неделю"
                                        data-tab="#days-chart">
                                  <div class="tooltip link__tooltip">
                      ...
                      <div class="link__settings">
                        <form class="form link-settings-form" action="#" method="post" autocomplete="off">
                          ...
                          <div class="form__input-wrapper panel-input-wrapper form__input-wrapper--link-password">
                            ...
                            <button class="form__button round-button round-button--clear clear-button"
                                    aria-label="Очистить поле пароль" type="button">
                              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                   stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                                   class="feather feather-x">
                                <line x1="18" y1="6" x2="6" y2="18"></line>
      ...
      <button type="button" class="trash-button" aria-label="Удалить ссылку">
