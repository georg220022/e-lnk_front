		...
		<div class="hero__body">
				...
				<form class="hero__form form" id="shortener-form" action="#" method="post" autocomplete="off">
					<div class="form__input-wrapper form__input-wrapper--long-link">
						<label class="form__label form__label--long-link" for="long-link">
							<input class="form__input form__input--long-link" id="long-link" type="url" name="longLink" aria-label="Длинная ссылка" placeholder="Введите ссылку для сокращения" required>
							<span class="error-label"></span>
						</label>
						<button class="form__button round-button shortener-button round-button--submit" id="shortener-submitBtn" type="submit" aria-label="Сократить ссылку" name="submit">
					...
					<div class="form__input-wrapper form__input-wrapper--short-link">
						...
						<label class="form__label form__label--short-link" for="short-link">
							<input class="form__input form__input--short-link short-link" id="short-link" type="url" name="shortLink" aria-label="Корткая ссылка" placeholder="Результат" readonly>
						</label>
						<button type="button" class="form__button round-button round-button--copy copy-button" aria-label="Скопировать ссылку">
			...
			<div class="hero__illustration-wrapper">
				<picture aria-hidden="true">
					<source srcset="./img/hero_illustration.webp" type="image/webp" aria-hidden="true">
					<img class="hero__illustration" src="./img/hero_illustration.png" aria-hidden="true" alt="иллюстрация">
				</picture>
			</div>
		</div>
  `;
